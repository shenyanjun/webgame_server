...
Skill_882000 = oo.class(Skill_magic_damage_add, "Skill_882000")

function Skill_882000:on_effect(param)
	--print("Skill_882000:on_effect")
...
Skill_882100 = oo.class(Skill_magic_damage_add, "Skill_882100")
...
Skill_882200 = oo.class(Skill_magic_damage_add, "Skill_882200")
...
Skill_882300 = oo.class(Skill_magic_damage_add, "Skill_882300")
...
function Skill_882300:on_effect(param)
	...
	if obj_d:get_type() == OBJ_TYPE_MONSTER then
		local impact_o = Impact_1281(obj_d:get_id())
		local param = {}
		param.sour_id = obj_s:get_id()
...
Skill_882400 = oo.class(Skill_magic_damage_add, "Skill_882400")
...
Skill_882500 = oo.class(Skill_magic_damage_add, "Skill_882500")
...
Skill_882600 = oo.class(Skill_magic_damage_add, "Skill_882600")
...
Skill_882700 = oo.class(Skill_magic_damage_add, "Skill_882700")
...
function Skill_882700:on_effect(param)
	...
	obj_s:add_mp(-self.expend_mp)
	return {0, damage_add}
end
f_skill_magic_damage_add_builder(SKILL_OBJ_882700)

--法宝三 2苍龙映月可以附加悟性点数*系数的毒攻伤害 {概率，系数}
Skill_882800 = oo.class(Skill_magic_damage_add, "Skill_882800")
...
Skill_882900 = oo.class(Skill_magic_damage_add, "Skill_882900")
...
Skill_883000 = oo.class(Skill_magic_damage_add, "Skill_883000")

function Skill_883000:on_effect(param)
	local obj_s = param.obj_s
	local obj_d = param.obj_d
	if obj_d == nil or not obj_d:is_alive() or obj_s:get_hp() / obj_s:get_max_hp() < 0.3 then
		return {0, 0}
	end
...
Skill_883100 = oo.class(Skill_magic_damage_add, "Skill_883100")
