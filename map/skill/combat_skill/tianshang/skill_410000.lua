...
--碎心诀 
Skill_410000 = oo.class(Skill_combat, "Skill_410000")

function Skill_410000:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_410000, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_410000][lv][2]
end
--param.des_id
function Skill_410000:effect(sour_id, param)
	...
	if ret == 2 then
		--套装附加攻击
		--local ak = self.ak + obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_410000)
		local set_l = obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_410000)
		...
		debug_print("Skill_410000:effect", sour_id, param.des_id, ak)
		return 0
	elseif ret == 1 then
...
f_create_skill_class("SKILL_OBJ_4100%02d", "Skill_4100%02d")
