...
--天雷破空
Skill_411100 = oo.class(Skill_combat, "Skill_411100")

function Skill_411100:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_411100, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_411100][lv][2]
	--self.sec = _sk_config._skill_p[SKILL_OBJ_411100][lv][3]
end
--param.des_id
function Skill_411100:effect(sour_id, param)
	...
	if ret == 2 then
		--套装附加攻击
		--local ak = self.ak + obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_411100)
		local set_l = obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_411100)
...
f_create_skill_class("SKILL_OBJ_4111%02d", "Skill_4111%02d")
