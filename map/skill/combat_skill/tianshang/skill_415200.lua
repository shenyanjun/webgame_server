...
--虚空新星 
Skill_415200 = oo.class(Skill_combat, "Skill_415200")

function Skill_415200:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_415200, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_415200][lv][2]
	self.stop_add = _sk_config._skill_p[SKILL_OBJ_415200][lv][3]
end
--param.des_id
function Skill_415200:effect(sour_id, param)
...
f_create_skill_class("SKILL_OBJ_4152%02d", "Skill_4152%02d")
