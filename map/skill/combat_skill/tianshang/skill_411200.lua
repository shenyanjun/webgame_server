...
--地动星沉
Skill_411200 = oo.class(Skill_combat, "Skill_411200")

function Skill_411200:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_411200, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_411200][lv][2]
	--self.sec = _sk_config._skill_p[SKILL_OBJ_411200][lv][3]
	--self.sp_per = _sk_config._skill_p[SKILL_OBJ_411200][lv][4]
end
--param.des_id
function Skill_411200:effect(sour_id, param)
	...
	if ret == 2 then
		...
		--伤害
		local new_pkt = self:make_hp_pkt(obj_s, obj_d, self.ak, 2)
		...
		debug_print("Skill_411200:effect", sour_id, param.des_id, ak)
		return 0
	elseif ret == 1 then
...
f_create_skill_class("SKILL_OBJ_4112%02d", "Skill_4112%02d")
