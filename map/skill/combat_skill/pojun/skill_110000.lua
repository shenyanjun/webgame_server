...
--破袭
Skill_110000 = oo.class(Skill_combat, "Skill_110000")

function Skill_110000:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_110000, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_110000][lv][2]
end
--param.des_id
function Skill_110000:effect(sour_id, param)
	...
	if ret == 2 then
		...
		debug_print("Skill_110000:effect", sour_id, param.des_id, ak)
		return 0
	elseif ret == 1 then
...
f_create_skill_class("SKILL_OBJ_1100%02d", "Skill_1100%02d")
