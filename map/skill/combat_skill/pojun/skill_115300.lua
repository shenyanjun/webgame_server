...
--禁·魂灭斩
Skill_115300 = oo.class(Skill_combat, "Skill_115300")

function Skill_115300:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_115300, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_115300][lv][2]
	self.silence_add = _sk_config._skill_p[SKILL_OBJ_115300][lv][3]
	self.boss_add = _sk_config._skill_p[SKILL_OBJ_115300][lv][4]
end
--param.des_id
function Skill_115300:effect(sour_id, param)
	--print("Skill_115300:effect", sour_id)
	...
	if ret == 2 then
		--套装附加攻击
		local set_l = obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_115300)
		...
		--print("Skill_115300:effect", sour_id, param.des_id, ak)
		return 0
	elseif ret == 1 then
...
f_create_skill_class("SKILL_OBJ_1153%02d", "Skill_1153%02d")
