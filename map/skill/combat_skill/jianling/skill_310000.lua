...
--星落斩 
Skill_310000 = oo.class(Skill_combat, "Skill_310000")

function Skill_310000:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_310000, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_310000][lv][2]
end
--param.des_id
function Skill_310000:effect(sour_id, param)
	...
	if ret == 2 then
		--套装附加攻击
		--local ak = self.ak + obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_310000)
		local set_l = obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_310000)
		...
		debug_print("Skill_310000:effect", sour_id, param.des_id)
		return 0
	elseif ret == 1 then
...
f_create_skill_class("SKILL_OBJ_3100%02d", "Skill_3100%02d")
