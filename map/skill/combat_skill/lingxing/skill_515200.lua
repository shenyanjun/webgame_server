...
--梦魇杀阵 
Skill_515200 = oo.class(Skill_combat, "Skill_515200")

function Skill_515200:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_515200, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_515200][lv][2]
	self.stop_add = _sk_config._skill_p[SKILL_OBJ_515200][lv][3]
end
--param.des_id
function Skill_515200:effect(sour_id, param)
...
f_create_skill_class("SKILL_OBJ_5152%02d", "Skill_5152%02d")
