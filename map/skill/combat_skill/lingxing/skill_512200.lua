...
--入梦
Skill_512200 = oo.class(Skill_combat, "Skill_512200")

function Skill_512200:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_512200, lv)
	self.sec = _sk_config._skill_p[SKILL_OBJ_512200][lv][2]
end

--param.des_id
function Skill_512200:effect(sour_id, param)
...
f_create_skill_class("SKILL_OBJ_5122%02d", "Skill_5122%02d")
