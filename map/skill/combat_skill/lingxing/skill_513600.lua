...
--单体攻击2
Skill_513600 = oo.class(Skill_combat, "Skill_513600")

function Skill_513600:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_513600, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_513600][lv][2]
end
--param.des_id
function Skill_513600:effect(sour_id, param)
	...
	if ret == 2 then
		--套装附加攻击
		--local ak = self.ak + obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_513600)
		local set_l = obj_s:get_set_effect(SKILL_ADD_ATTACK, SKILL_OBJ_513600)
...
f_create_skill_class("SKILL_OBJ_5136%02d", "Skill_5136%02d")
