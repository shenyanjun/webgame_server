...
--神骸杀阵
Skill_515400 = oo.class(Skill_combat, "Skill_515400")

function Skill_515400:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_515400, lv)
	self.ak = _sk_config._skill_p[SKILL_OBJ_515400][lv][2]
	self.stop_add = _sk_config._skill_p[SKILL_OBJ_515400][lv][3]
end
--param.des_id
function Skill_515400:effect(sour_id, param)
...
f_create_skill_class("SKILL_OBJ_5154%02d", "Skill_5154%02d")
