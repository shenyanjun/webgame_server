...
--魂摄六魄
Skill_211600 = oo.class(Skill_combat, "Skill_211600")

function Skill_211600:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_211600, lv)
	self.sec = _sk_config._skill_p[SKILL_OBJ_211600][lv][2]
end
--param.des_id
function Skill_211600:effect(sour_id, param)
	...
	--print("Skill_211600:effect", sour_id)
...
f_create_skill_class("SKILL_OBJ_2116%02d", "Skill_2116%02d")
