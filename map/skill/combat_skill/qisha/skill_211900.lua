...
--断魂
Skill_211900 = oo.class(Skill_combat, "Skill_211900")

function Skill_211900:__init(cmd_id, lv)
	Skill_combat.__init(self, cmd_id, SKILL_BAD, SKILL_OBJ_211900, lv)
	self.sec = _sk_config._skill_p[SKILL_OBJ_211900][lv][2]
end
--param nil
function Skill_211900:effect(sour_id, param)
	...
	if ret == 2 then
		--沉默效果
		local impact_o = Impact_1291(param.des_id)
...
f_create_skill_class("SKILL_OBJ_2119%02d", "Skill_2119%02d")
