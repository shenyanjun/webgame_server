...
module("pet_adventure.pet_matrix_barrier.pet_matrix_barrier_loader", package.seeall)

barrier_list = {}

function init()
	HandleXmlFile(CONFIG_DIR .. "xml/pet/pet_adventure/pet_adventure_matrix.xml")
						...
						local table_monster = {}
							for m,n in pairs(v.attr) do
								...
								elseif type(m) == "string" and m == "monster_name" then
									table_monster[4] = n
								elseif type(m) == "string" and m == "position" then
									table_monster[5] = tonumber(n)
								elseif type(m) == "string" and m == "strengh" then
									table_monster[6] = tonumber(n)
								elseif type(m) == "string" and m == "intelligence" then
									table_monster[7] = tonumber(n)
								elseif type(m) == "string" and m == "stemina" then
									table_monster[8] = tonumber(n)
								elseif type(m) == "string" and m == "dexterity" then
									table_monster[9] = tonumber(n)
								end
							end
